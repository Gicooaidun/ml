...
def setup_parser():
    ...
    parser.add_argument("--tilenames", type=str, default="/scratch2/biomass_estimation/code/ml/inference/data_manipulation/tile_names_inference_faster.txt")
...
if __name__ == "__main__":
    ...
    for s2_prod in tile_names:
        ...
        for t in range(len(s2_bands)):
            ...
            for i in range(7, icesat['bm'].shape[0], 30):
                for j in range(7, icesat['bm'].shape[1], 30):
        ...
        np.save(f'/scratch2/biomass_estimation/code/ml/inference/done_inference_tiles/inference_ensemble_{s2_prod}.npy', outputs)
        del outputs
        del s2_bands
        del icesat_norm
