...
if __name__ == "__main__":
    ...
    for s2_prod in tile_names:
        ...
        for t in range(len(s2_bands)):
            ...
            for i in range(7, 30, 15):
                for j in range(7, 30, 15):
        ...
        np.save(f'/scratch2/biomass_estimation/code/ml/inference/done_inference_tiles/debugging_inference_ensemble_{s2_prod}.npy', outputs)
        del outputs
        del s2_bands
        del icesat_norm
